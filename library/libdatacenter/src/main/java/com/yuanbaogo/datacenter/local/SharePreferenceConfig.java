...
/**
 * 创建时间: 2018/7/19
 * 创建人: https://github.com/CMzhizhe/mmkvUtils/tree/main/mmkvlibrary
 * 功能描述:
 */
public interface SharePreferenceConfig {
    void loadConfig();

    void loadConfig(String mmkvName);

    void loadConfigCRYPTKEY(String mmkvName);
    ...
    String CRYPTKEY = "yuanbao18522327220";
}

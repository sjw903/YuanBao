...
import com.yuanbaogo.homevideo.shortvideo.comment.model.SecondLevelBean;
...
public class VerticalCommentLayout extends LinearLayout implements
    ...
    private void init() {
        ...
        mCommentVerticalSpace = (int) ScreenUtils.dp2px(mContext,2f);
...
//                    showCount, generateMarginLayoutParams(showCount), true);
    ...
    private View makeContentView(SecondLevelBean content, int index) {
        View view = View.inflate(getContext(), R.layout.item_comment_child_new, null);
    ...
    private void bindViewData(View view, final SecondLevelBean content) {
        ...
        RoundImageView iv_header = view.findViewById(R.id.iv_header);
        ...
        iv_like.setImageResource(content.getIsLike() == 0 ? R.mipmap.icon_comment_like_unchioce : R.mipmap.icon_comment_like_chioce);

 ...
 */
public class FollowVideoPresenter extends MvpBasePersenter<FollowVideoContract.View>
        implements FollowVideoContract.Presenter {
    ...
    @Override
    public void getRecommendVideoList(int page, String size) {
        Map<String, String> params = new HashMap<>();
        params.put("page", page+"");
        params.put("size", size);
        NetWork.getInstance().get(getContext(), ChildUrl.followconcern, params, new RequestSateListener<RecommendVideoBean>() {
    ...
    public void getLiveVideoList() {
        ...
        NetWork.getInstance().get(getContext(), ChildUrl.liveconcern, null, new RequestSateListener<VideoLiveFollowListBean>() {

            @Override
            public void onSuccess(int var1, VideoLiveFollowListBean bean) {
                if (isActive())
                    getView().onLiveListSuccess(bean);
            }

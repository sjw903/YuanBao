package com.yuanbaogo.zui.recycler.adapter;
...
public abstract class BaseRecycleAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseRecycleAdapter(Context context, List<T> mDataList, int layoutId) {
    ...
    public void initPX(View view) {
        ...
        int width = screenWidth - 64;
        int item = width / 3;
        view.setLayoutParams(new RelativeLayout.LayoutParams(item, item / 3 * 4));
    }

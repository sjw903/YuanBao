 ...
 * @Modify:
 */
public class ShareDialogAdapter extends BaseRecycleAdapter<ArrayItemBean>
    ...
    public ShareDialogAdapter(Context context, List<ArrayItemBean> datas, int layoutId) {
    ...
    public void onBindItemHolder(BaseViewHolder holder, int position) {
        RelativeLayout itemShareViewRl = holder.getView(R.id.item_share_view_rl);
        TextView itemShareCiewTv = holder.getView(R.id.item_share_view_tv);
        ...
        itemShareViewRl.setOnClickListener(this);
        itemShareViewRl.setTag(position);
    }

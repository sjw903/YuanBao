...
/**
 * Created by nayiye on 2016/5/6.
 */
public class CertificateIdUtils {
...
//        Pattern p = Pattern.compile(".*[a-zA-Z].*[0-9]|.*[0-9].*[a-zA-Z]");
     ...
     * @return
     */
    public static boolean checkTaiwanId(String txt){
//        Pattern p = Pattern.compile("[0-9]*");
        Pattern p = Pattern.compile("^[A-Za-z0-9]{1,20}$");
        Matcher m = p.matcher(txt);
        return m.matches() && txt.length() == 8;
     ...
     * @return
     */
    public static boolean checkBusinessId(String txt){

...
public class AlbumSaver {
    ...
    private void saveVideoToDCIMOnAndroid10() {
        ...
        if (file.exists()) {
            ...
            Uri item = ApplicationConfigHelper.mApplication.getContentResolver().insert(collection, values);
            ParcelFileDescriptor pfd = null;
            FileOutputStream fos = null;
            FileInputStream fis = null;
            try {
                pfd = ApplicationConfigHelper.mApplication.getContentResolver().openFileDescriptor(item, "w");
            ...
            ApplicationConfigHelper.mApplication.getContentResolver().update(item, values, null, null);

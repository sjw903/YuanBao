    ...
    public void createThumbFile(@Nullable final ICoverListener listener) {
        AsyncTask<Void, String, String> task = new AsyncTask<Void, String, String>() {
            ...
            protected String doInBackground(Void... voids) {
                ...
                Bitmap bitmap = TXVideoInfoReader.getInstance(ApplicationConfigHelper.mApplication).getSampleImage(0, mVideoPath);
                if (bitmap == null) {
                    Log.e(TAG, "TXVideoInfoReader getSampleImage bitmap is null");
                    return null;
                }
                File sdcardDir = ApplicationConfigHelper.mApplication.getExternalFilesDir(null);
                if (sdcardDir == null) {

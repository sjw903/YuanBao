...
//                }
                NetworkUtil.getInstance(ApplicationConfigHelper.mApplication).setNetchangeListener(new NetworkUtil.NetchangeListener() {
                    @Override
                ...
                NetworkUtil.getInstance(ApplicationConfigHelper.mApplication).registerNetChangeReceiver();
            }
        });
    }
    ...
    public void release() {
        NetworkUtil.getInstance(ApplicationConfigHelper.mApplication).unregisterNetChangeReceiver();

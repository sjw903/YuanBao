...
public class AddPasterAdapter extends BaseRecyclerAdapter<AddPasterAdapter.AddPasterViewHolder> {
    ...
    public void onBindVH(@NonNull AddPasterViewHolder holder, int position) {
        ...
        holder.tvAddPasterText.setText(ApplicationConfigHelper.mApplication.getResources().getString(R.string.ugckit_add_paster_adapter_paster) + String.valueOf(position + 1));
        if (mCoverIcon != 0) {

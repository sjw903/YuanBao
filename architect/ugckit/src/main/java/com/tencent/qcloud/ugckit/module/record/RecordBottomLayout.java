...
//    private ImageView mImageTorch;                // 闪光灯
    ...
    private RecordRightLayout recordRightLayout;
...
//        mIsTorchOpenFlag = false;
        recordRightLayout.changeFlashlight(mFrontCameraFlag);
//        if (mFrontCameraFlag) {
//            mImageTorch.setVisibility(View.GONE);
//            mImageTorch.setImageResource(mTorchDisableImage);
//        } else {
...
//    }
    ...
    private void deleteLastPart() {
        ...
        if (!isSelectDeleteLastPartFlag) {
            ...
            mTextProgressTime.setText((int)timeSecond + getResources().getString(R.string.ugckit_unit_second));
    ...
    public void updateProgress(long milliSecond) {
        ...
        int second = (int) (milliSecond / 1000f);
        mTextProgressTime.setText(second + getResources().getString(R.string.ugckit_unit_second));
    }
    ...
    public void setRightLayout(RecordRightLayout recordRightLayout) {

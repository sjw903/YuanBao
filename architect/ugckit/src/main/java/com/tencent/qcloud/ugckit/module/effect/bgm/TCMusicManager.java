...
public class TCMusicManager {
    ...
    private SharedPreferences mPrefs = PreferenceManager.getDefaultSharedPreferences(ApplicationConfigHelper.mApplication);
...
//                    }.getType();
                    ArrayList<TCMusicInfo> bgmInfoList = (ArrayList<TCMusicInfo>) new GsonUtil().GsonToList(list.toString(), TCMusicInfo.class);

...
//                showPublishDialog();
    ...
    public void setVideoPath(String videoPath) {
        ...
        if (info == null) {
            ...
            info = TXVideoInfoReader.getInstance(ApplicationConfigHelper.mApplication).getVideoFileInfo(videoPath);
    ...
    public void initPlayer() {
        if (VideoEditerSDK.getInstance().getTXVideoInfo() != null) {
            ...
            int height = VideoEditerSDK.getInstance().getTXVideoInfo().width;
            Log.e("========短视频====编辑：：：", width + "===width====height===" + height);

    ...
    private void selectAnotherAspect(int targetScale) {
        ...
        switch (mCurrentAspect) {
            case TXRecordCommon.VIDEO_ASPECT_RATIO_9_16:
                ...
                mImageAspectCurr.setImageResource(R.mipmap.icon_aspect_916);
                mImageAspectFirst.setImageResource(R.mipmap.icon_aspect_11);
                mImageAspectSecond.setImageResource(R.mipmap.icon_aspect_34);
                mImageAspectThird.setImageResource(R.mipmap.icon_aspect_43);
                mImageAspectFourth.setImageResource(R.mipmap.icon_aspect_169);
            ...
            case TXRecordCommon.VIDEO_ASPECT_RATIO_3_4:
                ...
                mImageAspectCurr.setImageResource(R.mipmap.icon_aspect_34);
                mImageAspectFirst.setImageResource(R.mipmap.icon_aspect_11);
                mImageAspectSecond.setImageResource(R.mipmap.icon_aspect_916);
                mImageAspectThird.setImageResource(R.mipmap.icon_aspect_43);
                mImageAspectFourth.setImageResource(R.mipmap.icon_aspect_169);
            ...
            case TXRecordCommon.VIDEO_ASPECT_RATIO_1_1:
                ...
                mImageAspectCurr.setImageResource(R.mipmap.icon_aspect_11);
                mImageAspectFirst.setImageResource(R.mipmap.icon_aspect_34);
                mImageAspectSecond.setImageResource(R.mipmap.icon_aspect_916);
                mImageAspectThird.setImageResource(R.mipmap.icon_aspect_43);
                mImageAspectFourth.setImageResource(R.mipmap.icon_aspect_169);
            ...
            case TXRecordCommon.VIDEO_ASPECT_RATIO_4_3:
                ...
                mImageAspectCurr.setImageResource(R.mipmap.icon_aspect_43);
                mImageAspectFirst.setImageResource(R.mipmap.icon_aspect_34);
                mImageAspectSecond.setImageResource(R.mipmap.icon_aspect_916);
                mImageAspectThird.setImageResource(R.mipmap.icon_aspect_11);
                mImageAspectFourth.setImageResource(R.mipmap.icon_aspect_169);
            ...
            case TXRecordCommon.VIDEO_ASPECT_RATIO_16_9:
                ...
                mImageAspectCurr.setImageResource(R.mipmap.icon_aspect_169);
                mImageAspectFirst.setImageResource(R.mipmap.icon_aspect_34);
                mImageAspectSecond.setImageResource(R.mipmap.icon_aspect_916);
                mImageAspectThird.setImageResource(R.mipmap.icon_aspect_11);
                mImageAspectFourth.setImageResource(R.mipmap.icon_aspect_43);

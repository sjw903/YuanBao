...
public class VideoEditerSDK {
    ...
    public TXVideoEditConstants.TXVideoInfo getTXVideoInfo() {
        mTXVideoInfo = TXVideoInfoReader.getInstance(ApplicationConfigHelper.mApplication).getVideoFileInfo(mVideoPath);
     ...
     */
    public void initSDK() {
        mTXVideoEditer = new TXVideoEditer(ApplicationConfigHelper.mApplication);
    }

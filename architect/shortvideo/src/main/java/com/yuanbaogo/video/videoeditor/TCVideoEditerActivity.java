...
import com.yuanbaogo.video.videopublish.view.VideoPublishActivity;
import com.yuanbaogo.zui.dialog.CommonRemindPop;

import androidx.annotation.NonNull;


public class TCVideoEditerActivity extends MvpBaseActivityImpl<VideoEditerContract.View, VideoEditerPresenter>
        implements VideoEditerContract.View, View.OnClickListener {
    ...
    //返回确定弹窗
    CommonRemindPop mCommonRemindPop;
    ...
    private void showCustomDialog() {
        mCommonRemindPop = new CommonRemindPop(TCVideoEditerActivity.this, getString(R.string.sure_delete_edit), getString(R.string.btn_cancel),  getString(R.string.btn_confirm),
                new CommonRemindPop.OnClickListener() {
                    @Override
                    public void onLeftClick() {
                        mCommonRemindPop.dismiss();
                    }
        ...
        mCommonRemindPop.setShipLeftColor(getColor(R.color.colorAAAAAA));
        mCommonRemindPop.setShipRightColor(getColor(R.color.colorEA5504));
       mCommonRemindPop.showAtLocation(getWindow().getDecorView(), Gravity.CENTER | Gravity.CENTER_HORIZONTAL, 0, 0);
    }
...
//            Intent intent = new Intent(getApplicationContext(), TCVideoPublisherActivity.class);
        Intent intent = new Intent(getApplicationContext(), VideoPublishActivity.class);

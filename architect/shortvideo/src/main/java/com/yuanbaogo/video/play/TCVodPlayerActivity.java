package com.yuanbaogo.video.play;
...
import com.yuanbaogo.video.play.contract.VideoPlayerContract;
import com.yuanbaogo.video.play.presenter.VideoPlayerPresenter;
import com.yuanbaogo.video.userinfo.UserInfoUtil;
import com.yuanbaogo.video.videorecord.FollowRecordDownloader;
 ...
 * 短视频播放页
 */
public class TCVodPlayerActivity extends MvpBaseActivityImpl<VideoPlayerContract.View, VideoPlayerPresenter>
        implements VideoPlayerContract.View, ITXVodPlayListener, TelephonyUtil.OnTelephoneListener {
